        ...
        <div>
            ...
            <div class="bg-white relative shadow rounded-lg w-5/6 md:w-5/6  lg:w-4/6 xl:w-3/6 mx-auto">
                ...
                <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" name="image">Add an image to your post?</div>
                    <!-- <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="image">Upload an avatar</label>
                <input class="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id = "image" name="image" type="file" value="{{$user->profile->avatar}}">
                <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="image" name="image">Upload an image to your profile..</div> -->
